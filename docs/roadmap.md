...
6. CLI inspection: `lumina routes --json`, `lumina inspect --json`, `lumina inspect why`, minimal `lumina map affected --json`, `lumina bench --list --json`, and `lumina bench <name> --json` are implemented for app, route, direct-import route-impact, and benchmark-skeleton evidence.
