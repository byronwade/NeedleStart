...
- Scaffolded `apps/www` marketing app source with shadcn-style UI primitives, Tailwind v4/shadcn configuration files, light/dark theme tokens, a persisted theme toggle, a static public-docs route scaffold for the docs home plus start, concepts, guide, reference, deployment, and community pages, an SSR `/docs/*` visual inventory viewer backed by metadata for the current `docs/public/` page set, verified starter example under `examples/basic/`, runnable content example under `examples/blog-seo/`, and scaffolded examples under `examples/multi-app-workspace/`, `examples/large-100-routes/`, and `examples/large-1000-routes/`, with route-discovery and inspect fixture evidence.
...
- Full Markdown-to-public-docs rendering, generated docs search, generated docs sidebars, frontmatter parsing, and generated per-document static public routes for every source Markdown file.
