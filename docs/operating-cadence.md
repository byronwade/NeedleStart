...
This document defines the planned rhythm for keeping NeedleStart disciplined as implementation starts. The project is still Phase 0, so these are operating targets rather than active release ceremonies.
