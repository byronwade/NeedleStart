...
| --- | --- | --- | --- |
| Early speed skeleton | Create stable fixture and benchmark paths before route discovery expands. | `docs/implementation-speed-rules.md`, `docs/benchmark-fixtures.md` | Skeleton files, route-discovery and manifest-size local raw metadata, remaining `not implemented` graph-query and adapter-dispatch surfaces, and no synthetic results |
