...
### 6. Machine-Readable Docs Contract Check
...
### 11. Configuration Contract Check
...
### 19. Accessibility Contract Check
...
- `docs:check` validates required docs, required links, local Markdown links, public docs navigation coverage, AI playbook placement, verification-section coverage, scaffold-status language, adapter package paths, and the current `bun.lockb` lockfile name.
