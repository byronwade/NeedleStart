...
The current `apps/www` Markdown body renderer, in-app inventory sidebar, and SSR search route are scaffolded custom preview paths, not the final renderer, generated-navigation, or generated-search decision.
