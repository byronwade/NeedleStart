...
The target message is: Bun is the default adapter path for speed-sensitive deployments, with Node and static adapter paths designed early enough to avoid Bun lock-in.
