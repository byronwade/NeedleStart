...
| `docs/public/reference/project-structure.md` | App developers, contributors, agents | New | Planned until scaffold exists | Replace target structure with verified generated app structure after Phase 1 | High | Low | Partial | Yes |
